...
Created: 2026-05-30T18:32:36Z

## Note

Mia is the built-in AI agent for Mianotes. It helps humans and other agents turn messy input into reusable Markdown notes.
...
Mia runs as a backend service and agent layer, not frontend-only behaviour. The web app can collect prompts and show results, but the backend owns:
