...
Install from GitHub when you want editable source checkouts of Mianotes. This path is best for developers, contributors, and people wiring Mianotes into local agent workflows.
